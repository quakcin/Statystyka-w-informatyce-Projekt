...
export const _imiona_damskie = [ 'Anna', 'Maria', 'Zofia', 'Julia', 'Aleksandra', 'Natalia', 'Karolina', 'Emilia', 'Wiktoria', 'Marta', 'Oliwia', 'Weronika', 'Paulina', 'Gabriela', 'Izabela', 'Patrycja', 'Monika', 'Kinga', 'Agnieszka', 'Ewa'];
export const _nazwiska_damskie = [ 'Kowalska', 'Nowak', 'Wiśniewska', 'Wójcik', 'Kowalczyk', 'Zielińska', 'Szymańska', 'Lewandowska', 'Dąbrowska', 'Piotrowska', 'Jabłońska', 'Majewska', 'Król', 'Pawlak', 'Kaczmarek', 'Stępień', 'Chmielewska', 'Bąk', 'Walentowicz', 'Zawadzka'];
